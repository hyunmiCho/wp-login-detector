...
// csson - 상수 미선언시 발생하는 오류 방지
if(!defined('CRIMINALIP_DEFAULT_NUM_OF_FAILED_LOGINS_BY_IP_BEFORE_CAPTCHA_SHOWN'))
{
	define('CRIMINALIP_DEFAULT_NUM_OF_FAILED_LOGINS_BY_IP_BEFORE_CAPTCHA_SHOWN', '');
}
...
class Criminalip_Admin_Form {
	...
	public function register_settings() {
		...
		register_setting(
			'criminalip-test-options-group',							// Option group name
		...
		add_settings_field(
			...
			array(
				...
				//'middle_text' => __( '초 동안', 'criminalip_test' ),
				//'after_text' => __( ' 번 이상의 접근을 할 경우.', 'criminalip_test' ),
				'before_text' => __( 'The external IP is accessed within', 'criminalip_test' ),
				'middle_text' => __( 'seconds more than', 'criminalip_test' ),
				'after_text' => __( ' times.', 'criminalip_test' ),
				'default2' => '1',
				'default3'   => '1',
			)							 
		);  
		...
		add_settings_field(
			...
			'criminalip_test_block_ip_settings_section',						// The name of the section to which this field belongs
			array(
				// csson - 설정 저장 시, label_for 누락되어 값이 저장되지 않는 점 수정
				...
				'default2'   => CRIMINALIP_DEFAULT_NUM_OF_FAILED_LOGINS_BY_IP_BEFORE_CAPTCHA_SHOWN,
			)															// The array of arguments to pass to the callback
		);
